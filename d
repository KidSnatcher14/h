...
function Library:NewLine(info)
	...
	l.Color = info.Color or Color3.fromRGB(255,71,77);
...
if false then
	...
	while true do
		for _, skeleton in next, Skeletons do
			skeleton:SetColor(Color3.fromRGB(skeleton.Player.TeamColor == LocalPlayer.TeamColor and Color3.fromRGB(255, 71, 77) or Color3.fromRGB(255, 71, 77)));
